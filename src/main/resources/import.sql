...
INSERT INTO QUESTION (id, writer_id, title, contents, create_date) VALUES (1, '2', '징고 첫 질문(첫글)', '징고 첫 질문 내용', CURRENT_TIMESTAMP());
INSERT INTO QUESTION (id, writer_id, title, contents, create_date) VALUES (2, '2', '징고 두번째 질문', '징고 두 질문 내용', CURRENT_TIMESTAMP());
INSERT INTO QUESTION (id, writer_id, title, contents, create_date) VALUES (3, '1', '무빙이 첫 질문', '무빙이 첫 질문 내용', CURRENT_TIMESTAMP());
INSERT INTO QUESTION (id, writer_id, title, contents, create_date) VALUES (4, '1', '무빙이 두번째 질문(최신 글)', '무빙이 두번째 질문 내용', CURRENT_TIMESTAMP());
